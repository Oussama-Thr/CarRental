  ...
  <thead class="bg-secondary text-light text-center">
    ...
    <tbody style="background-color: #eaf4f4; color: #333;">
        ...
        <tr class='text-center'>
            ...
            <td><a href="{{ route('edit_brand', ['id' => $data->id]) }}" class='btn btn-warning'>&nbsp;&nbsp;Edit&nbsp;&nbsp;</a>&nbsp;&nbsp;&nbsp;
                <a onclick="return confirm('Confirm Delete?')" class="btn btn-danger" href="{{url('delete_brand',$data->id)}}">Delete</a></td>
        </tr>
        @endforeach
