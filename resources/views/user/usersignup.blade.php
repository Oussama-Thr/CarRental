...
<body>
    ...
    <footer class="footer">
        <div class="d-sm-flex justify-content-center justify-content-sm-between">
            <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">CarRental <br> Rent cars at your
                convenience</span>

            <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center"> Contact<br> Email:
                contact@CarRental.com <br> Phone: +8801928363 <br>Address: Brac University, Dhaka, Bangldadesh </span>
        </div>
    </footer>
</body>
