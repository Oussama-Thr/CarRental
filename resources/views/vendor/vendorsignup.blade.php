  ...
  <body>
    ...
    <style>
        body {
          ...
          overflow: visible; /* Hide the body's default scrollbar */
        }
    ...
    <footer class="footer">
            <div class="d-sm-flex justify-content-center justify-content-sm-between">
              <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">CarRental <br> Rent korei dekho</span>

              <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center"> Contact<br> Email: CarRental@gmail.com <br> Phone: +8801928363 <br>Address: Brac University, Dhaka, Bangldadesh </span>
            </div>
          </footer>
  </body>
</html>
